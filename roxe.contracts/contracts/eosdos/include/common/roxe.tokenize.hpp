...
class tokenize {
 ...
 public:
    ...
    */
   [[roxe::action]] void create(const name& issuer, const asset& maximum_supply);
    ...
    */
   [[roxe::action]] void issue(const name& from, const name& to, const asset& quantity, const string& memo);
    ...
    */
   [[roxe::action]] void retire(const name& from, const asset& quantity, const string& memo);
    ...
    */
   [[roxe::action]] void addauthor(const symbol& sym, const name& author);
    ...
    * @param sym - the symbol of tokens,
    */
   [[roxe::action]] void delauthor(const symbol& sym, const name& from);
    ...
    * @param memo - the memo string to accompany the transaction.
    */
   [[roxe::action]] void transfer(const name& from, const name& to, const asset& quantity, const string& memo);
    ...
    */
   [[roxe::action]] void open(const name& owner, const symbol& symbol, const name& ram_payer);
    ...
    */
   [[roxe::action]] void close(const name& owner, const symbol& symbol);
 ...
 private:
   struct [[roxe::table("accountsize"), roxe::contract("eoswap")]] account {
      asset balance;

      uint64_t primary_key() const { return balance.symbol.code().raw(); }
   };

   struct [[roxe::table("statize"), roxe::contract("eoswap")]] currency_stats {
      asset        supply;
      asset        max_supply;
      name         issuer;
      vector<name> authors;
   ...
   typedef roxe::multi_index<"accountsize"_n, account>    accounts;
   typedef roxe::multi_index<"statize"_n, currency_stats> stats;
