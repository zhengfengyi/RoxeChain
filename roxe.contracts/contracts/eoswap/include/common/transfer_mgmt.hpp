...
class transfer_mgmt {
 ...
 public:
   ...
   static int64_t
   get_transfer_fee(const extended_asset& quantity, bool is_in = false) {
      ...
      if (quantity.contract != "roxe.ro"_n || !tokenize::is_exist_symbol(quantity.quantity.symbol.code(), tokencontract)) {
         my_print_f(
