# /Users/lisheng/mygit/roxe/roxe.cdt/build/bin/roxe-cpp -abigen src/eoswap.cpp -o src/eoswap.wasm
...
# cleos --wallet-url http://127.0.0.1:6666 --url http://127.0.0.1:8000  set account permission useraaaaaaab  active '{"threshold": 1,"keys": [{"key": "'EOS7yBtksm8Kkg85r4in4uCbfN77uRwe82apM8jjbhFVDgEgz3w8S'","weight": 1}],"accounts": [{"permission":{"actor":"'eoswapeoswap'","permission":"roxe.code"},"weight":1}]}' owner -p useraaaaaaab@owner

# cleos --wallet-url http://127.0.0.1:6666 --url http://127.0.0.1:8000 push action eoswapeoswap extransfer '["useraaaaaaab","useraaaaaaac",{quantity : "1.0000 SYS",contract : "roxe.token"},""]' -p useraaaaaaab@active
